import { Camera, Vector3 } from "minimal-gpu"
...
const KEYBOARD_ZOOM_SPEED = 0.4
const KEYBOARD_MOVE_SPEED = Math.PI * 40
...
export class OrbitControls {
  ...
  /** The speed factor for panning and orbiting. Default is `5` */
  public speed = 5
  ...
  zoom(scale: number): void {
    const radius = this._camera.position.sub(this.center).len()
